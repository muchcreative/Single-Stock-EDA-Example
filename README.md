...
Check winsorization or filtering or even if they can be applied here. There is a high chance that this type of filling reduces the volatility of the stock and therefore losing the information from the relationships between other features you may have if you have a trained multivariate ml system. This can easily lead to model drift (reducing overall model accuracy). If that is the case, outliers should not be removed, but should be accounted for in a strategy or ml system.
